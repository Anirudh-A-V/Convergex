    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.chipsContainer}>
        {formData.interests.map(interest => (
          <Chip key={interest} style={styles.chip} onClose={() => handleRemoveInterest(interest)}>
            {interest}
          </Chip>
        ))}
      </View>
      ...
      <Button mode="contained" onPress={handleSaveChanges} style={styles.saveButton} buttonColor="#34C759">
        Save Changes
      </Button>
    </ScrollView>
  );
